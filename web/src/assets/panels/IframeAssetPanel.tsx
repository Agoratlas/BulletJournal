...
export function IframeAssetPanel({ asset, panelInfo, onReadyStateChange, sectionId, frameVariant }: SimpleAssetPanelProps) {
  ...
  if (!iframeUrl) {
    return (
      <AssetPanelFrame asset={asset} panelInfo={panelInfo} sectionId={sectionId} frameVariant={frameVariant} showExportActions>
