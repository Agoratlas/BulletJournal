        ...
        definition={
            **base_asset_definition(
            ...
            'encodings': {
                ...
                'y': {
                    'column': str(asset.value),
                    'data_type': str(asset.dataframe.dtypes[asset.value]),
                    'aggregate': normalized_aggregation,
                    'kind': 'quantitative',
                },
            },
            'visual_defaults': {
                'bar_width': default_modifiers['bar_width'],
                'border_thickness': default_modifiers['border_thickness'],
                'y_scale_type': 'linear',
                'bar_corner_radius': 3,
            },
            'vega_template_kind': 'bar_chart',
            'bar_category_column': str(asset.category),
            'bar_category_column_type': str(asset.dataframe.dtypes[asset.category]),
            'bar_value_column': str(asset.value),
            'bar_value_column_type': str(asset.dataframe.dtypes[asset.value]),
            'bar_aggregation': normalized_aggregation,
            'bar_color_column': asset.color if isinstance(asset.color, str) else None,
